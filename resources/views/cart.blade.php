            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="cart">
                        ...
                        <h2 class="cart-title">In Your Shopping Cart: <span class="c-primary"> {{Cart::content()->count()}} items</span></h2>
                                ...
                                <td class="product-thumbnail">
                                    ...
                                    <div class="cart-product__item">
                                        ...
                                        <div class="cart-product-content">
                                            ...
                                            <h5 class="cart-product-name">{{$pdt->name}}</h5>
                                        </div>
                                    </div>
                                </td>

                                <td class="product-price">
                                    <h5 class="price amount">BAM {{$pdt->price}}</h5>
                                </td>
